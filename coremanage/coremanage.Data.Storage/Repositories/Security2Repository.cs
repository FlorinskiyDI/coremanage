...
{
    public class Security2Repository : Repository<CoreManageDbContext>
    {
        //private readonly CoreManageDbContext Context;

        public Security2Repository(ILogger<LoggerDataAccess> logger, CoreManageDbContext context) : base(logger, context)
        {
            //Context = context;
        }
        ...
        //        ProfileModel model = query.FirstOrDefaultAsync().Result;SuperGroupAdminRoles
